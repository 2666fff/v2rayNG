...
import com.artw.jiasu.JiasuActivity
...
class JiasuRecyclerAdapter(val activity: JiasuActivity) : RecyclerView.Adapter<JiasuRecyclerAdapter.BaseViewHolder>()
    ...
    private var mActivity: JiasuActivity = activity
